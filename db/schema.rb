...
ActiveRecord::Schema[8.0].define(version: 2026_07_03_200202) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "summary_status", default: "idle", null: false
    t.index ["user_id", "created_at"], name: "index_bookmarks_on_user_id_and_created_at"
    t.index ["user_id"], name: "index_bookmarks_on_user_id"
  end

  create_table "presale_sessions", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "company_name"
    t.string "contact_name"
    t.string "segment"
    t.string "operational_profile"
    t.integer "discussed_criticalities", default: [], null: false, array: true
    ...
    t.string "prospect_role"
    t.string "hubspot_contact_id"
    t.integer "suggested_criticalities", default: [], null: false, array: true
    t.integer "selected_criticalities", array: true
    t.boolean "show_intro", default: true, null: false
    t.integer "criticalities_order", array: true
    t.boolean "show_hub", default: true, null: false
    t.jsonb "extra_criticalities", default: [], null: false
    t.jsonb "qualification_answers", default: {}, null: false
    t.index ["hubspot_contact_id"], name: "index_presale_sessions_on_hubspot_contact_id"
  ...
  add_foreign_key "presale_sessions", "users"
