...
- Questo milestone è nel contesto interno (design system del template) e riusa la vista debrief e la logica di invio recap del milestone 5.
...
4. Al completamento, scrivi un `milestone-log.md` in questa cartella (`_build_plan/milestones/6-archivio-sessioni/milestone-log.md`). Strutturalo così:
